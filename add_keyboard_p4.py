...
def add_file_to_pbxproj(proj_path, file_path, group_name, target_name):
    ...
    file_ref_id = f"P4_KEYBOARDHANDLER_SWIFT_REF"
    build_file_id = f"P4_KEYBOARDHANDLER_SWIFT_BUILD"
...
add_file_to_pbxproj(proj, 'ClipVault/Services/KeyboardHandler.swift', 'Services', 'ClipVault')
